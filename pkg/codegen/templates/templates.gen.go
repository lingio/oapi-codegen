...
{{end}}
`,
	"embedded.tmpl": `//go:embed spec.yaml
var specFile []byte

var rawSpec = func() ([]byte, error) {
    return specFile, nil
}
...
//
// Code generated by github.com/oapi-codegen DO NOT EDIT.
package {{.PackageName}}
...
import (
	...
	{{if ne .ModelPackageName ""}} . {{.ModelPackageName}}{{end}}
